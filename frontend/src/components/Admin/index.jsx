...
import { ShieldCheck, BookOpen, LogOut, Users, PlayCircle } from 'lucide-react';
import { api, useAuthStore } from '../../store/authStore';
import { API } from '../SuperAdmin/constants'; // Reuse same API path logic
            ...
            <header className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-bold text-gray-900 text-sm leading-none">Admin Control</p>
                            <p className="text-xs text-gray-400 font-mono mt-0.5">{user?.name} · {user?.studentId}</p>
                        </div>
                    </div>
                    <button
                        onClick={logout}
