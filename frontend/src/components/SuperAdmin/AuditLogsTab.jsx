                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        {isAnomalous && (
                                                            <div className="relative group/tooltip flex items-center">
                                                                <AlertTriangle size={14} className="text-amber-500 ml-1 cursor-help" />
                                                                {(log.flags && log.flags.length > 0) && (
                                                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-slate-800 text-white text-[10px] rounded-lg opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-all shadow-xl z-50 pointer-events-none">
                                                                        <div className="font-black text-slate-300 uppercase tracking-widest mb-1 border-b border-slate-700 pb-1">Recorded Flags</div>
